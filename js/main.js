...
config.domReady(function() {
	config.instance = new config.animationConstruct([document.querySelectorAll('tr[class=c36] td[class*=c43]')[1], document.querySelectorAll('tr[class=c36] td[class*=c8]')[2]], document.querySelectorAll('tr[class=c56] td[class*=c64]')[0]);
